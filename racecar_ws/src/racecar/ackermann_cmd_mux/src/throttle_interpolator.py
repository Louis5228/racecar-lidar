...
class InterpolateThrottle:
    def __init__(self):
        ...
        self.rpm_input_topic   = rospy.get_param('~rpm_input_topic', '/racecar/commands/motor/unsmoothed_speed')
        self.rpm_output_topic  = rospy.get_param('~rpm_output_topic', '/racecar/commands/motor/speed')

        self.servo_input_topic   = rospy.get_param('~servo_input_topic', '/racecar/commands/servo/unsmoothed_position')
        self.servo_output_topic  = rospy.get_param('~servo_output_topic', '/racecar/commands/servo/position')

        self.max_acceleration = rospy.get_param('/racecar/max_acceleration')
        self.max_rpm = rospy.get_param('/racecar/vesc_driver/speed_max')
        self.min_rpm = rospy.get_param('/racecar/vesc_driver/speed_min')
        self.throttle_smoother_rate = rospy.get_param('/racecar/throttle_smoother_rate')
        self.speed_to_erpm_gain = rospy.get_param('/racecar/speed_to_erpm_gain')

        self.max_servo_speed = rospy.get_param('/racecar/max_servo_speed')
        self.steering_angle_to_servo_gain = rospy.get_param('/racecar/steering_angle_to_servo_gain')
        self.servo_smoother_rate = rospy.get_param('/racecar/servo_smoother_rate')
        self.max_servo = rospy.get_param('/racecar/vesc_driver/servo_max')
        self.min_servo = rospy.get_param('/racecar/vesc_driver/servo_min')

        # Variables
        self.last_rpm = 0
        self.desired_rpm = self.last_rpm
        
        self.last_servo = rospy.get_param('/racecar/steering_angle_to_servo_offset')
